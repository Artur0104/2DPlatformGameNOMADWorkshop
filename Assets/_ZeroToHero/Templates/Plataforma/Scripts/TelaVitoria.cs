...
{
    /// <summary>
    /// Controlador da tela de vitória. Faz bind dos botões Menu e Reiniciar.
    /// Exibe o Panel quando o estado do jogo é Vitoria.
    /// </summary>
    public class TelaVitoria : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            bool deveMostrar = GerenciadorJogo.Instancia.EstadoAtual == EstadoJogo.Vitoria;
